 ...
 */
static unsigned char s5k4ba_init_reg[][3] = {
		{0x31,0x03,0x93},
	{0x30,0x08, 0x82}, //»Ì∏¥Œª£¨–Ë—” ±
	...
	{0x3a,0x13,0x30},
	{0x36,0x00,0x52},
	{0x36,0x04,0x48}, //724, 68, for blue
	{0x36,0x06,0x1b},
	{0x30,0x12,0x00},
	{0x47,0x40,0x21},
	{0x3c,0x00,0x04},
...
//VGA PREVIEW
    ...
    {0x38,0x06, 0x03},                                                           
    {0x38,0x07, 0xc0},                                                           
    {0x38,0x08, 0x02},//0x04},  //0811, for preview output 640*480              
    {0x38,0x09, 0x80},//0x00},  //0811, for preview output 640*480            
    {0x38,0x0a, 0x01},//0x03},  //0811, for preview output 640*480              
    {0x38,0x0b, 0xe0},//0x00},  //0811, for preview output 640*480           
    {0x38,0x0c, 0x0c},                                                           
    {0x38,0x0d, 0x80},                                                           
    {0x38,0x0e, 0x04}, //818,   //frame rate to 14.3 fps, for flicker     
    {0x38,0x0f, 0x30}, //818,   //frame rate to 14.3 fps, for flicker     
    {0x38,0x10, 0x40},                                                           
    {0x38,0x15, 0x03},                                                           
    {0x38,0x18, 0xc1},                                                           
    {0x38,0x24, 0x11},                                                           
