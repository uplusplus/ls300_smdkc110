...
unsigned long s3c_irqwake_intmask	= 0xfffffffdL;
...
static int s3c_pm_enter(suspend_state_t state)
{
	...
	__raw_writel(0xff0000ff,(S5P_VA_DMC0 + 0x28));
	__raw_writel(0xff0000ff,(S5P_VA_DMC1 + 0x28));
	...
	*/
    ...
    printk("S5P_INFORMIVALUE %x\n",S5P_INFORM1);
	printk("s3c_sleep_save_phys=0x%08lx\n", s3c_sleep_save_phys);
	printk("gpio GPH0 0x%08lx\n",__raw_readl(S5P_VA_GPIO+0xc00));
	...
	printk("mem pwrdnConfig0 %08lx\n",(unsigned long )__raw_readl((S5P_VA_DMC0 + 0x28)));
	printk("mem pwrdnConfig1 %08lx\n",(unsigned long )__raw_readl((S5P_VA_DMC1 + 0x28)));
	...
	//by fanwb s3c_pm_debug_smdkled(1 << 1, 0);
